...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static void sendNotification(Context context, String messageBody, String channelUrl) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setColor(Color.parseColor("#6d481d"))  // small icon background color
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.icon_edgar))
