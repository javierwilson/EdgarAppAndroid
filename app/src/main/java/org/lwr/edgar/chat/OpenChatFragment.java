...
import org.lwr.edgar.utils.MediaPlayerActivity;
import org.lwr.edgar.utils.PhotoViewerActivity;
...
public class OpenChatFragment extends Fragment {
    ...
    public static OpenChatFragment newInstance(@NonNull String channelUrl) {
        ...
        args.putString(OpenChannelActivity.EXTRA_OPEN_CHANNEL_URL, channelUrl);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mChannelUrl = getArguments().getString(OpenChannelActivity.EXTRA_OPEN_CHANNEL_URL);
    ...
    private void showMessageOptionsDialog(final BaseMessage message, final int position) {
        String[] options = new String[] {  "Copiar mensaje" ,"Editar mensaje", "Eliminar mensaje"};
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (which == 0) {
                    System.out.println(((UserMessage)message).getMessage());
    ...
    private void requestImage() {
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            startActivityForResult(Intent.createChooser(intent, "Seleccionar Archivo"), INTENT_REQUEST_CHOOSE_IMAGE);
                ...
                openChannel.enter(new OpenChannel.OpenChannelEnterHandler() {
                    ...
                    public void onResult(SendBirdException e) {
                        ...
                        if (getActivity() != null) {
                            ...
                            ((OpenChannelActivity) getActivity()).setActionBarTitle("Pregunta a Edgar");
                        }
