...
import org.lwr.edgar.utils.UrlPreviewInfo;
import org.lwr.edgar.utils.WebUtils;
...
public class GroupChatFragment extends Fragment {
    ...
    private void refresh() {
        System.out.println("groupChannel 1");

        if (mChannel == null) {
            System.out.println("groupChannel 2");
            ...
            GroupChannel.getChannel(mChannelUrl, new GroupChannel.GroupChannelGetHandler() {
                ...
                public void onResult(GroupChannel groupChannel, SendBirdException e) {
                    ...
                    System.out.println("groupChannel "+groupChannel.getUrl());
    ...
    private void showMessageOptionsDialog(final BaseMessage message, final int position) {
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 0) {
                    String text = ((UserMessage)message).getMessage();
                    ClipboardManager clipboard = (ClipboardManager) getContext().getSystemService(Context.CLIPBOARD_SERVICE);
                    ClipData clip = ClipData.newPlainText("text",  text);
                    clipboard.setPrimaryClip(clip);

                    Toast toast2 = Toast.makeText(getContext(),
                                    "Mensaje copiado", Toast.LENGTH_SHORT);
